				...
				<div class="content-wrapper">
							...
							<div class="card">
								<div class="card-body">
										...
										<div class="search-field d-none d-xl-block"
											...
											<div class="input-group-prepend bg-transparent"
												...
												<input type="text"
													...
													id="vlSearchValue" name="vlSearchValue"
													value="${vlSearchValue }">
												<div id="btnSearch"
									...
									<table class="table table-striped">
										...
										<tbody>
											<c:if test="${!empty list}">
												<c:set var="count"
													value="${paging.totalCount - (listPage -1 ) * paging.listCount}" />
									...
									<input type="button" onClick="fn_Upload(${curPage})"
										class="btn btn-secondary ml-1 mt-3" value="목록">
					...
					<form name="admVoteForm" id="admVoteForm" method="post">
						...
						<input type="hidden" name="curPage" id="curPage"
							...
							id="searchType" value="${searchType}" /> <input type="hidden"
							name="searchValue" id="searchValue" value="${searchValue}" /> <input
							type="hidden" name="vlSearchType" id="vlSearchType"
							value="${vlSearchType}" /> <input type="hidden"
							name="vlSearchValue" id="vlSearchValue" value="${vlSearchValue}" />
						<input type="hidden" name="listPage" id="listPage"
							value="${listPage}" />
					</form>
				</div>
				<!-- main-panel ends -->
