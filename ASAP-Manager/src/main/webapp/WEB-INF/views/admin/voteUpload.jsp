				...
				<div class="content-wrapper">
					...
					<div class="row">
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">작품 업로드 관리 및 투표자 조회</h4>
												...
												<c:forEach var="list" items="${list}" varStatus="status">
													<tr>
														...
														<td><fmt:formatNumber type="number"
																maxFractionDigits="3" value="${list.vrTotalCnt}" /></td>
														<td><fmt:formatNumber type="number"
																maxFractionDigits="3" value="${list.vrStartPrice}" /></td>
														<td>${list.regDate}</td>
														<td><c:choose>
														...
														<td>
															<div class="voteList">
																<a href="javascript:void(0)" style="cursor: pointer;"
																	onclick="fn_voteList(${list.vrSeq})"> 투표자 확인 </a>
															</div>
														</td>
													</tr>
												</c:forEach>
					...
					<form name="admVoteForm" id="admVoteForm" method="post">
						...
						<input type="hidden" name="curPage" id="curPage"
							...
							name="searchValue" id="searchValue" value="${searchValue}" />
					</form>
				</div>
				<!-- main-panel ends -->
			</div>
