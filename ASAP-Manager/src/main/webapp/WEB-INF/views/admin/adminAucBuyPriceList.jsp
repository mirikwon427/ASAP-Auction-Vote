									...
									<div class="search-field d-none d-xl-block"
										...
										<div class="input-group-prepend bg-transparent"
											...
											<input type="text"
												...
												placeholder="낙찰자 검색..." name="searchValue" id="searchValue"
												value="${searchValue }">
											<div id="btnSearch"
														...
														<td>
															<div>
																<span><fmt:formatNumber type="number"
																		maxFractionDigits="3" value="${auction.vrStartPrice}" /></span>
															</div>
														</td>
														<td>
															<div>
																<span><fmt:formatNumber type="number"
																		maxFractionDigits="3" value="${auction.aucBuyPrice}" /></span>
															</div>
														</td>
														<td>
															<div>
