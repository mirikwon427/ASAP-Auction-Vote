			...
			<div class="main-panel">
				<div class="content-wrapper">
								...
								<div class="card-body">
									...
									<div class="form-group"
										...
										<select id="searchType" name="searchType"
											...
											<option value="2"
												<c:if test = '${searchType eq "2"}'>selected</c:if>>상품명</option>
										</select>
									...
									<div
										style="text-align: left !important; margin-bottom: 10px; display: flex;">
										<button type="button" class="btn btn-outline-primary"
											id="btnBidY" style="margin-right: 5px; height: 40px;">낙찰선정</button>
										<button type="button" class="btn btn-outline-primary"
											id="btnReturn" style="margin-right: 5px; height: 40px;">돌려주기</button>
										<button type="button" class="btn btn-outline-primary"
											id="btnStatusY" style="margin-right: 5px; height: 40px;">경매시작</button>
										<button type="button" class="btn btn-outline-primary"
											id="btnStatusN" style="margin-right: 5px; height: 40px;">경매종료</button>
										<div style="margin-left: auto; margin-bottom: 10px;">
											<input type="button" onclick="fn_upload()"
												class="btn btn-primary" value="이벤트 경매 올리기">
										</div>
									</div>
												...
												<c:forEach var="list" items="${list}" varStatus="status">
													<tr>
														...
														<td><fmt:formatNumber type="number"
																maxFractionDigits="3" value="${list.aeStartPrice}" /></td>
					...
					<form name="aeForm" id="aeForm" method="post">
						<input type="hidden" name="aeSeq" id="aeSeq" value="${aeSeq}" /> <input
							type="hidden" name="curPage" id="curPage" value="${curPage}" />
