				...
				<div class="content-wrapper">
								...
								<div class="card-body">
									...
									<div class="form-group"
										...
										<div id="btnSearch" class="input-group-prepend bg-transparent"
											style="width: 100px; height: 41px; margin-left: 5px;">
											<i
												class="input-group-text bg-transparent border-0 mdi mdi-magnify"
												style="cursor: pointer; border-radius: 20%"></i>
										</div>
									</div>
												...
												<c:forEach var="voteUpload" items="${list}"
													...
													<tr>
														...
														<td><fmt:formatNumber type="number"
																maxFractionDigits="3" value="${voteUpload.vrTotalCnt}" /></td>
														<td><c:set var="originalDate1"
																value="${voteUpload.vrStartDate}" /> <c:set var="year1"
																value="${fn:substring(originalDate1, 0, 4)}" /> <c:set
																var="month1"
																value="${fn:substring(originalDate1, 4, 6)}" /> <c:set
																var="day1" value="${fn:substring(originalDate1, 6, 8)}" />
															${year1}.${month1}.${day1}</td>
														<td><c:set var="originalDate"
																value="${voteUpload.vrEndDate}" /> <c:set var="year"
																value="${fn:substring(originalDate, 0, 4)}" /> <c:set
																var="month" value="${fn:substring(originalDate, 4, 6)}" />
															<c:set var="day"
																value="${fn:substring(originalDate, 6, 8)}" />
															${year}.${month}.${day}</td>
														<td>
															<div>
																<c:choose>
					...
					<form name="bbsForm" id="bbsForm" method="post">
						...
						<input type="hidden" id="monthValue" name="monthValue"
							value="${monthValue}" /> <input type="hidden" id="gnbAdmId"
							value="${gnbAdmId }" />
					</form>
				</div>
				<!-- main-panel ends -->
