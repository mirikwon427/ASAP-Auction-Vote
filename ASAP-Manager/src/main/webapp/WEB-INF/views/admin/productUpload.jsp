						...
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<form name="productUploadForm" id="productUploadForm"
										...
										<div class="form-group">
											<label for="exampleTextarea1">재고 수량 *</label> <input
												type="number" style="width: 30%;" class="form-control"
										...
										<div class="form-group">
											<label for="exampleTextarea1">상품 판매 시작일 *</label> <input
												type="date" style="width: 30%;" class="form-control"
												name="productStartDate" id="productStartDate" value="">
										</div>
										<div class="form-group">
											<label for="exampleTextarea1">상품 판매 종료일 *</label> <input
												type="date" style="width: 30%;" class="form-control"
												name="productEndDate" id="productEndDate" value="">
										</div>
										<div class="form-group">
											<label for="exampleTextarea1">상품 설명 *</label>
											<textarea class="form-control" rows="10" id="productDetail"
												name="productDetail"></textarea>
										</div>
										<div class="form-group">
											<label for="exampleSelectGender">상품 사진 첨부 *</label> <input
												type="file" id="productFile" name="productFile" class="mb-3">
										</div>

										<input type="button" class="btn btn-light" onclick="fn_list()"
											value="  취소  "> <input type="button"
											name="btnProductUpload" id="btnProductUpload"
											class="btn btn-primary ml-1" value=" 상품 올리기 ">
									</form>
