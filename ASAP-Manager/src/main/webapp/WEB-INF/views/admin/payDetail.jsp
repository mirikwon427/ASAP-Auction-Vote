							...
							<div class="card">
								<div class="card-body">
									...
									<c:if test="${!empty list}">
										...
										<br>
										<h7 style="color: #007bff;">아이디 : ${list[0].userId}</h7>
									</c:if>
											...
											<c:if test="${!empty list}">
												<c:forEach var="orderDetail" items="${list}">
													<tr>
														...
														<td><img
															src="/resources/upload/product/${orderDetail.productSeq}.png"></td>
														<td>${orderDetail.productName}</td>
														<td>${orderDetail.orderDetailQuantity}</td>
														<c:choose>
															<c:when test="${orderDetail.productSeq eq 1 }">
																<td><fmt:formatNumber type="number"
																		maxFractionDigits="3"
																		value="${orderDetail.orderDetailPrice}" /></td>
															</c:when>
															<c:otherwise>
																<td><fmt:formatNumber type="number"
																		maxFractionDigits="3"
																		value="${orderDetail.productPrice}" /></td>
															</c:otherwise>
														</c:choose>
														<td><fmt:formatNumber type="number"
																maxFractionDigits="3"
									...
									<input type="button" onClick="fn_back()"
