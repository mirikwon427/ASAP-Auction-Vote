										...
										<div class="search-field d-none d-xl-block"
											...
											<div class="input-group-prepend bg-transparent"
												...
												<input type="text"
													...
													name="userIdSearch" id="userIdSearch"
													placeholder="아이디 검색..." value="${userIdSearch}">
												<div id="btnSearch"
												...
												<c:if test="${!empty list}">
													...
													<c:forEach var="user" items="${list}" varStatus="status">
														<tr>
															...
															<td><c:choose>
																	<c:when test="${user.userCode == 'W'}">
																		<label class="badge badge-info artAccess"
																			id="artAccess">승인</label>
															...
															<td><label
																class="badge badge-success userInfoUpdate"
																id="userInfoUpdate" style="cursor: pointer;">확인및수정</label>
																<input type="hidden" id="updateUserId"
																name="updateUserId" value="${user.userId}"></td>
														</tr>
