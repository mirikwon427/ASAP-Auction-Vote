								...
								<div class="card-body">
									...
									<div style="text-align: center;">
										<input type="button" class="btn btn-secondary"
											onclick="fn_back()" value="  목록  "> <input
											type="button" class="btn btn-primary ml-1"
											onclick="fn_update()" value="  수정  ">
									</div>
									<form name="productUpdateForm" id="productUpdateForm"
												...
												<div class="col-lg-7 pb-5" style="margin: auto;!important;">
													...
													<div class="d-flex mb-3">
														<input type="text" style="width: 50%;"
															class="font-weight-semi-bold" id="productName"
															name="productName" value="${product.productName}">
													</div>
													상품 가격&nbsp; : &nbsp;
													<div class="d-flex mb-3">
														<input type="number" style="width: 30%;" id="productPrice"
													...
													<div class="d-flex mb-3">
														상품 판매 시작일&nbsp; : &nbsp; <input type="text"
															style="width: 20%;" id="productStartDate"
															name="productStartDate"
															value="${product.productStartDate}">&nbsp;&nbsp;
														상품 판매 종료일&nbsp; : &nbsp; <input type="text"
															style="width: 20%;" id="productEndDate"
															name="productEndDate" value="${product.productEndDate}">
													</div>
												</div>
													...
													<div class="tab-content"
														...
														<div class="tab-pane fade show active" id="tab-pane-1">
															<textarea class="form-control" rows="10"
																id="productDetail" name="productDetail">${product.productDetail}</textarea>
														</div>
