...
<body>
				...
				<div class="content-wrapper">
					...
					<div class="row">
						...
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">문의사항 작성</h4>
									<form class="forms-sample">
										<div class="form-group h5">
											<!-- 수정 -->
											<label for="exampleInputPassword4">관리자 아이디
												${admin.admId} </label>
											<!-- 수정 -->
										...
										<div class="form-group">
											...
											<textarea class="form-control" rows="10" name="nbContent"
												id="nbContent" placeholder="내용을 입력해주세요"></textarea>
										</div>
										<input type="button" class="btn btn-secondary" id="btnList"
											value="  목록  "> <input type="button"
											class="btn btn-primary ml-1" id="btnWrite" value="  저장  ">
									</form>
								</div>
							</div>
						</div>
	...
	<form name="bbsForm" id="bbsForm" method="post">
		<input type="hidden" name="searchType" value="" /> <input
			...
			name="curPage" value="" /> <input type="hidden" name="admId"
			id="admId" value="${admin.admId}" />
	</form>
</body>
</html>