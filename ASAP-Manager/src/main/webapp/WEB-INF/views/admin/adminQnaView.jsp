										...
										<div class="form-group h4">
											<ul style="list-style-type: none; display: flex;">
												<li
													...
													<i class="mdi mdi-account"></i>&ensp; <c:out
														value="${qnaBoard.userId}" /> <c:out
														value="${qnaBoard.admId}" />
												</li> &ensp;&ensp;
												<li
													style="display: flex; align-items: center; margin-right: 10px;">
												...
												<li style="display: flex; align-items: center;"><i
													class="mdi mdi-tag-multiple"></i>&ensp;문의사항</li>
											</ul>
										</div>
										<div class="form-group h3"
											style="color: #5F5F5F; margin-left: 15px; width: 70%;">
											${qnaBoard.qaContent}</div>
										<button type="button" id="btnList"
											style="margin-left: 10px; margin-top: 10px;"
											class="btn btn-outline-secondary btn-icon-text">
											<i class="mdi mdi-replay"></i>목록
										</button>
										<c:if test="${empty qnaBoard.admId}">
											<button type="button" id="btnReply"
												style="margin-left: 5px; margin-top: 10px;"
												class="btn btn-outline-primary btn-icon-text">
												<i class="mdi mdi-message-reply-text"></i> 답변
											</button>
										</c:if>
