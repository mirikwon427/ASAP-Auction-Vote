						...
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<form name="aeUploadForm" id="aeUploadForm" method="post"
										enctype="multipart/form-data">
										<div class="form-group">
											<label for="exampleInputEmail3">경매 이름 *</label> <input
												type="text" style="width: 50%;" class="form-control"
												name="aeTitle" id="aeTitle" value="">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword4">상품 이름 *</label> <input
												type="text" style="width: 30%;" class="form-control"
												name="aeProductTitle" id="aeProductTitle" value="">
										</div>
										<div class="form-group">
											<label for="exampleTextarea1">시작가 *</label> <input
												type="number" style="width: 30%;" class="form-control"
												name="aeStartPrice" id="aeStartPrice" value=""
												placeholder="0">
										</div>
										<div class="form-group">
											<label for="exampleTextarea1">경매 시작시간 *</label> <input
												type="text" style="width: 30%;" class="form-control"
												name="aeStartTime" id="aeStartTime" value="${user.userPwd}">
										</div>
										<div class="form-group">
											<label for="exampleTextarea1">경매 종료시간 *</label> <input
												type="text" style="width: 30%;" class="form-control"
												name="aeEndTime" id="aeEndTime" value="${user.userEmail}">
										</div>
										<div class="form-group">
											<label for="exampleSelectGender">배너 사진 첨부 *</label> <input
												type="file" id="bannerFile" name="bannerFile" class="mb-5">
										</div>
										<div class="form-group">
											<label for="exampleSelectGender">상품 사진 첨부 *</label> <input
												type="file" id="mainFile" name="mainFile" class="mb-5">
										</div>
										<div class="form-group">
											<label for="exampleSelectGender">설명 사진 첨부 *</label> <input
												type="file" id="detailFile" name="detailFile" class="mb-5">
										</div>
										<input type="button" class="btn btn-light" onclick="fn_list()"
											value="  취소  "> <input type="button"
											name="btnAeUpload" id="btnAeUpload"
											class="btn btn-primary ml-1" value=" 이벤트 경매 올리기 ">
									</form>
