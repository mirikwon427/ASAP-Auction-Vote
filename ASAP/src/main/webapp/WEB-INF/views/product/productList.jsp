   ...
   <div class="container-xxl py-5">
      <div class="container" style="width:80%;">
         <div class="section-title text-center mx-auto wow fadeInUp"
            ...
            <h1 class="display-6">경매 파생 상품</h1>
            <br>
         </div>
         <div class="row g-4">
            <!-- 상품 1개 시작 -->
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp mb-3" data-wow-delay="0.1s">
                     <div class="store-item position-relative text-center">
                        ...
                        <div class="store-overlay">
                           <a onclick="fn_detail(${product.productSeq})" class="btn btn-primary rounded-pill py-2 px-4 m-2" style="font-size:20px;">More Detail 
                              <i class="fa fa-arrow-right ms-2"></i>
                           </a> 
                           <a onclick="addCart(${product.productSeq})" class="btn btn-dark rounded-pill py-2 px-4 m-2" style="font-size:20px;">Add to Cart 
