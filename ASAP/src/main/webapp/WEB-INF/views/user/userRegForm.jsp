...
$(document).ready(function() {
	...
	$("#isId").on("click", function(){
		...
		if(!IdCheck.test($("#userId2").val())){
			$("#userId2").val("");
			$("#userId2").focus();
			Swal.fire("아이디 4~15자, 영대소문자, 숫자만 입력이 가능합니다.", '', 'warning');
			return;
		}
	...
	$("#btnReg").on("click", function() {
		...
		if(!IdCheck.test($("#userId2").val())){
			$("#userId2").val("");
			$("#userId2").focus();
			Swal.fire("아이디 4~15자, 영대소문자, 숫자만 입력이 가능합니다.", '', 'info');
			return;
		}
                               ...
                               <ul class="pms-form-fields-wrapper pl-0">
                                <li class="pms-field pms-user-login-field">
                                    ...
                                    <div class="row form-group">
	                                    <div class="col-md-8">
	                                    	<input type="text" id="userId2" name="userId2" value="" placeholder="영문/숫자 조합 (4~15자)">
	                                    </div>
	                                    <div class="col-md-4">
                                ...
                                <li class="pms-field pms-pass1-field">
                                    ...
                                    <input type="password" id="userPwd1" name="userPwd1" placeholder="영문/숫자/특수문자 모두 포함되는 조합 (8~15자)">
                                </li>
