...
function isAucCurPrice(){
	...
	if($("#aucCurPrice").val() < vrStartPrice){
		$("#aucCurPrice").val("");
		$("#aucCurPrice").focus();
...
<body>
	...
	<section class="position-relative gen-section-padding-3">
		<div class="tv-single-background">
			<img src="/resources/images/background/back.png"
				alt="stream-lab-image" style="height: 900px;">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
											...
											<c:choose>
															...
															<div
																...
																*시작가: &#8361;
																<fmt:formatNumber type="number" maxFractionDigits="3"
																	value="${vrDetail.vrStartPrice}" />
															</div>
														</div>
														<div class="col-md-7">
															<input type="button" onclick="isAucCurPrice()"
																value="입찰하기" /><br> <input type="hidden"
																name="userId" id="userId" value="${vrDetail.userId}" />
															<input type="hidden" id="aucSeq" name="aucSeq"
																value="${aucSeq}" /> <input type="hidden"
																id="aucCurPrice" name="aucCurPrice"
																value="${aucCurPrice}" />
														</div>
													</div>
												</c:when>
												<c:when test="${vrDetail.aucStatus == 'N'}">
													<span class="text"><font color="#BD2A2E"><font
															size="4"><strong>종료된 경매 입니다.</strong></font></font></span>
												</c:when>
												<c:otherwise>
													<span class="text"><font color="#BD2A2E"><font
								...
								<div class="gen-season-holder">
									<ul class="nav">
										...
										<li class="nav-item"><a class="nav-link"
											data-toggle="tab" href="#aucCur">입찰가 내역</a></li>
										<li class="nav-item"><a class="nav-link"
											data-toggle="tab" href="#comment">댓글</a></li>
									</ul>
								</div>
								<!-- 카테고리 시작 -->
