					...
					<div class="col-xl-3 col-md-12 order-2 order-xl-1 mt-4 mt-xl-0" style="width:20%;">
						<div class="widget widget_recent_entries">
							...
							<ul>
								...
								<li><a href="/myPage/myPageVoteUpload">투표업로드내역</a></li>
								</c:if>
							</ul>
						</div>
					</div>
																...
																<c:if test="${!empty list1}">
																	<c:forEach var="voteUpload1" items="${list1}"
																		...
																		<tr>
																			...
																			<td>
																				<div class="cell-inner">
																					<span onclick="fn_detail(${voteUpload1.vrSeq})" style="cursor:pointer;color: #FAFAD2;text-decoration: underline;">${voteUpload1.vrTitle}</span>
																				</div>
																			</td>
																			<td>
																				<div class="cell-inner">
																					<span>${voteUpload1.voteDate}</span>
																				</div>
																			</td>
																			<td>
																				<div class="cell-inner">
