               ...
               <c:if test="${boardMe eq 'N'}"  > 
                       <div class="cell-btn-holder">
                            <div class="gen-btn-container">
                                <div class="gen-button-block"style="cursor:pointer;">
 									<a class="gen-button" id="btnWrite" style="float:right;cursor:pointer;">
						...
						<c:set var="startNum" value="${paging.startNum}"/>
							...
							<input type="hidden" name="status" id="stauts" value="${qnaBoard.status}" />
 							...
 							<c:if test = "${qnaBoard.qaIndent>0}">
                           		<img src = "/resources/images/icon_reply.png" style="margin-left:${qnaBoard.qaIndent}em"/>
                           	</c:if>
                                            <span><c:out value="${qnaBoard.qaTitle}" /></span>
 </a>
                                        </div>
                                    </td>
                                    <td>
